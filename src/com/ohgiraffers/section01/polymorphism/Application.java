...
public class Application {
    public static void main(String[] args) {
         ...
         * Rabbit 은 Rabbit 타입이기도 하면서 Aniaml 타입이기도 하다.
...
//        Tiger t = new Animal();
         ...
         * 런타임 당시 실제 객체가 가진 오버라이딩 된 메소드로 바인딩이 바뀌어 동작하는 것을
         * 동적 바인딩이라고 한다.*/
...
//        a2.bite();
        ...
        /* 타입 형변환을 잘못하는 경우 */
        // 컴파일 에러는 발생하지 않지만, 런타임 에러가 발생한다.
        //((Tiger)a1).bite(); //런타임 에러 발생

        /* 레퍼런스 변수가 참조하는 실제 인스턴스가 원하는 타입과 맞는지 비교하는 instaceof 연산자 */
        // 레퍼런스 변수 instanceof 자료형 클래스명
        ...
        Rabbit rabbitt1 = (Rabbit) animal1; // down-casting 명시적 형변환으로 가능
        // Rabbit rabbitt2 = animal1; // down-casting 묵시적 형변환 불가능

        // 다형성이란?
        // 하나의 객체(인스턴스)가 여러 타입을 가질 수 있다.
        // ex ) new Rabbit(); 은 Rabbit,Animal,Object 타입을 가지고 있다.
    }
